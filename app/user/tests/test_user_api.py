"""
Docstring for app.user.tests.test_user_api
"""
...
class PublicUserApiTests(TestCase):
    """
    Docstring for PublicUserApiTests
    """
    def setUp(self):
    ...
    def test_create_user_success(self):
        """
        Docstring for test_create_user_success
    ...
    def text_user_with_email_exists_error(self):
        """
        Docstring for text_user_with_email_exists_error
